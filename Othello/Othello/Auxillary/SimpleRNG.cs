...
namespace Othello.Auxillary
{
    public class SimpleRNG
    {
        ...
        public static double GetWeibull(double shape, double scale)
        {
            ...
            {
                string msg = string.Format("Shape and scale weights must be positive. Recieved shape {0} and scale{1}.", shape, scale);
                throw new ArgumentOutOfRangeException(msg);
            }
        ...
        public static double GetBeta(double a, double b)
        {
            if (a <= 0.0 || b <= 0.0)
            {
                string msg = string.Format("Beta weights must be positive. Received {0} and {1}.", a, b);
                throw new ArgumentOutOfRangeException(msg);
            }
